                        ...
                        <Stack spacing='5'>
                            <Box>
                                ...
                                <Flex>
                                    ...
                                    <Text fontSize='md' fontWeight='bold' ml='4px'>{product.numberOfReviews} {product.numberOfReviews === 1 ? 'review' : 'reviews'}</Text>
                                </Flex>
                            </Box>
                            <Text>{product.description}</Text>
                            <Text fontWeight='bold'>Quantity</Text>
                            <Flex w='170px' p='5px' border='1px' borderColor='gray.200' alignItems='center'>
                                <Button onClick={() => changeAmount('minus')} isDisabled={amount <= 1}><MinusIcon/></Button>
